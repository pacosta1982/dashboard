...
class ProjectResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            'id' => $this->SEOBId,
            'sat' => trim($this->SEOBEmpr),
            'nombre' => trim($this->SEOBProy),
            'departamento' => trim($this->DptoId?$this->departamento->DptoNom:""),
            'distrito' => trim($this->CiuId?$this->distrito->CiuNom:""),
            'estado' => trim($this->SEOBEst?$this->estado->name:""),
            'avance' => number_format($this->SEOBFisAva,0,'.','.'),
            'viviendas' => $this->SEOBViv,
            'expediente' => $this->SEOBNroExp,
            'terreno' =>$array[rtrim($this->SEOBTerr)],
            'coordenadas' => $latlong = $this->ToLL((int)$this->SEOBUtmY,(int)$this->SEOBUtmX,preg_replace("/[^0-9]/", '', isset($this->SEOBUtm1)? '21J' : $this->SEOBUtm1)),
